    ...
    <AnimatePresence>
      <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/90 backdrop-blur-md">
        <motion.div
          ...
          className="relative w-full max-w-lg max-h-[85vh] overflow-y-auto bg-zinc-950 rounded-2xl border border-white/15 p-6 sm:p-8 shadow-2xl"
        >
          <button
            onClick={onClose}
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
              <h2 className="text-xl font-syne font-bold text-white">Settings</h2>
              <p className="text-xs text-zinc-400 font-mono">Customize interface behavior & storage</p>
            </div>
          </div>

          <div className="space-y-6 text-xs font-sans text-zinc-300">
            {/* Creativity Slider */}
            <div>
